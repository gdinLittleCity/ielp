							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="password" class="form-control1" id="password"
										placeholder="密码" name="password" value="${admin.password }">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="password" class="form-control1" id="repassword"
										placeholder="确认密码" name="repassword" value="${admin.password }">
								</div>
...
$("#addForm").validate({
	...
	$("#errorPhone").text("");
	 ...
	 password:function(){
  	...
  	repassword:function(){var publicKeyExponent = "${publicKeyExponent}";
  		var publicKeyModulus = "${publicKeyModulus}";
	 ...
	 var postUrl = "${pageContext.request.contextPath }/admin/manager/super/updateAdministor.action" ;
