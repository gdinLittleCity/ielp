				...
				<div class="tab-content">
					<div class="tab-pane active" id="horizontal-form">
						<form class="form-horizontal" id="addForm" method="post">
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control1" id="cname"
										placeholder="二级分类名" name="cname" value="${cateogry.cname }">
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" class="form-control1" id="note"
										placeholder="备注" name="desc" value="${cateogry.desc }">
								</div>
								<div class="col-sm-6">
							...
							<div class="form-group">
								<label for="selector1" class="col-sm-2 control-label">所属一级分类
									</label>
								<div class="col-sm-4">
									<select name="parent.cid" id="selector1" class="form-control1" placeholder="一级分类">
...
rules:{
	...
	submitHandler: function(form) {
	 ...
	 var postUrl = "${pageContext.request.contextPath }/admin/category/saveSecondCategory.action" ;
